/*
Deployment script for Northwind_1.3
...
GO
:setvar DatabaseName "Northwind_1.3"
:setvar DefaultFilePrefix "Northwind_1.3"
...
GO
PRINT N'Rename refactoring operation with key d3a1ae6c-332e-4f36-ba72-3ee48c155366 is skipped, element [dbo].[Region] (SqlTable) will not be renamed to [Regions]';
...
GO
PRINT N'Creating [dbo].[Сredit cards]...';
...
GO
PRINT N'Creating [dbo].[FK_CartHolder_EmployeeID]...';


GO
ALTER TABLE [dbo].[Сredit cards] WITH NOCHECK
    ADD CONSTRAINT [FK_CartHolder_EmployeeID] FOREIGN KEY ([Card holder]) REFERENCES [dbo].[Employees] ([EmployeeID]);
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd3a1ae6c-332e-4f36-ba72-3ee48c155366')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d3a1ae6c-332e-4f36-ba72-3ee48c155366')
...
ALTER TABLE [dbo].[Сredit cards] WITH CHECK CHECK CONSTRAINT [FK_CartHolder_EmployeeID];
